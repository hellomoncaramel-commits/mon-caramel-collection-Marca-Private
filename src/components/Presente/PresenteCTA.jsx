...
export default function PresenteCTA({ onAction, label = "Quero montar o meu →" }) {
  return (
    <div className="mt-10 rounded-3xl p-5 text-center" style={{ backgroundColor: COLORS.subtle }}>
      <p className="text-lg font-display text-brand-ink mb-1">Gostou de uma ideia?</p>
      <p className="text-sm mb-4 text-brand-inkSoft">
        Use essas fotos como inspiração. A gente monta algo do seu jeito para a ocasião, quantidade e tema que você
        precisa.
      </p>
      <button
        onClick={onAction}
